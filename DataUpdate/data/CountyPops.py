...
counties_df = pd.read_csv('COVID-CASES-Counties-DF.txt', sep='\t') 
counties_df = counties_df[~counties_df['Admin2'].isin(['Unassigned', 'Out-of-state', 
                                ...
                                'Out of OK', 'Out of PR', 'Out of TN', 'Out of UT', 'Out of CH'])]


cty_pops = pd.read_excel('co-est2019-annres.xlsx')
...
cty_pops.to_pickle('County_Pops.pkl')
